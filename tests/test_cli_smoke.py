...
def test_resident_runtime_preset_throughput_v4_native_completion_applies_default_values() -> None:
    ...
    assert args.resident_native_completion_wave_fill_us == 1000
    assert args.resident_native_completion_wave_fill_mode == "multi_wait"
...
def test_cli_guardrails_auto_discovers_run_resident_result_contract(tmp_path: Path):
    ...
    source_dq_checks = [
        "source_dq_available",
        "invalid_samples_accounted",
        "invalid_samples_applied",
        "resident_streaming_route",
    ]
    write_json(
            ...
            "groups": [
                {
                    ...
                    "source_counts": {},
                    "status_counts": {"no_invalid_samples": 3},
                    "streaming_memory": {
                        "invalid_mask_bytes_per_pixel": 1,
                        "estimated_per_frame_mask_bytes": 4,
                        "batch_frames": 3,
                        "estimated_batch_mask_bytes": 12,
                        "estimated_all_frame_mask_bytes": 12,
                    },
                    "checks": [{"name": name, "passed": True, "details": {}} for name in source_dq_checks],
                }
            ],
        },
    )
            ...
            "groups": [
                {
                    ...
                    "active_frame_count": 3,
                    "masked_frame_count": 0,
                    "source_input_samples": 12,
                    "source_input_invalid_samples_before_rejection": 0,
                    "all_frame_input_invalid_samples_before_frame_mask": 0,
                    "checks": [{"name": name, "passed": True, "details": {}} for name in lifecycle_checks],
                }
            ],
        },
    )

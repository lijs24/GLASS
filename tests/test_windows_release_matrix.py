...
def _release_quality_final_evidence(
    *,
    ...
    fields: dict[str, object] = {
        ...
        "final_evidence_detail_fields_present": True,
...
def _release_decision(
    ...
    *,
    ...
    release_quality_final_checks_compatible_missing = (
        not include_release_quality_publication_final_checks
        and not include_phase2_release_quality_publication_final_checks
    )
    release_quality_final_checks_match = (
        include_release_quality_publication_final_checks
        == include_phase2_release_quality_publication_final_checks
        and (
            release_quality_final_checks_compatible_missing
            or release_quality_publication_final_checks_ready
            == phase2_release_quality_publication_final_checks_ready
        )
    )
    release_quality_final_checks_ready = release_quality_final_checks_compatible_missing or (
        include_release_quality_publication_final_checks
        and include_phase2_release_quality_publication_final_checks
        and release_quality_publication_final_checks_ready
        and phase2_release_quality_publication_final_checks_ready
        and release_quality_final_checks_match
    )
    ...
    release_quality_guard = (
        {
            ...
            "final_checks_ready": release_quality_final_checks_ready,
            "final_checks_match": release_quality_final_checks_match,
    ...
    write_json(
        path,
        {
            ...
            "acceptance_benchmark_contract": {
                "schema_version": 1,
                "present": benchmark_contract_profile is not None,
...
def _default_promotion(
    ...
    *,
    ...
    phase2_release_decision_release_quality_publication_final_checks_ready: bool | None = None,
    include_release_decision_release_quality_publication_final_checks: bool = True,
    include_phase2_release_decision_release_quality_publication_final_checks: bool = True,
    ...
    release_decision_release_quality_publication_final_checks_ready = (
        release_decision_release_quality_publication_guard_ready
        if release_decision_release_quality_publication_final_checks_ready is None
        else release_decision_release_quality_publication_final_checks_ready
    )
    phase2_release_decision_release_quality_publication_final_checks_ready = (
        phase2_release_decision_release_quality_publication_guard_ready
        if phase2_release_decision_release_quality_publication_final_checks_ready is None
        else phase2_release_decision_release_quality_publication_final_checks_ready
    )
    release_decision_release_quality_final_checks_compatible_missing = (
        not include_release_decision_release_quality_publication_final_checks
        and not include_phase2_release_decision_release_quality_publication_final_checks
    )
    release_decision_release_quality_final_checks_match = (
        ...
        and (
            release_decision_release_quality_final_checks_compatible_missing
            or release_decision_release_quality_publication_final_checks_ready
            == phase2_release_decision_release_quality_publication_final_checks_ready
        )
    )
    release_decision_release_quality_final_checks_ready = (
        release_decision_release_quality_final_checks_compatible_missing
        or (
            include_release_decision_release_quality_publication_final_checks
            and include_phase2_release_decision_release_quality_publication_final_checks
            and release_decision_release_quality_publication_final_checks_ready
            and phase2_release_decision_release_quality_publication_final_checks_ready
            and release_decision_release_quality_final_checks_match
        )
    )
    release_decision_release_quality_chain_ready = (
        release_decision_release_quality_publication_guard_ready
        and phase2_release_decision_release_quality_publication_guard_ready
        and release_decision_release_quality_final_checks_ready
    )
    ...
    benchmark_profiles_agree = (
        benchmark_profile_decision_profile
        == benchmark_profile_phase2_profile
        == benchmark_profile_default_route_profile
        == RESIDENT_CUDA_DQ_PROFILE_NAME
    )
    benchmark_handoff_ready = (
        benchmark_profile_handoff_ready
        and benchmark_profiles_agree
        and benchmark_profile_decision_check_passed
    )
    manifest_ready = (
        ready
    ...
    payload = {
            ...
            "benchmark_contract_profile_handoff": {
                "schema_version": 1,
                "ready": benchmark_handoff_ready,
                "required_profile": RESIDENT_CUDA_DQ_PROFILE_NAME,
                "profiles_agree": benchmark_profiles_agree,
                "decision": {
                    "present": benchmark_profile_decision_profile is not None,
                    "ready": (
                        benchmark_profile_decision_profile
                        == RESIDENT_CUDA_DQ_PROFILE_NAME
                        and benchmark_profile_decision_check_passed
                    ),
                    "check_passed": benchmark_profile_decision_check_passed,
                    "source": "profile",
                    "path": None,
                    "profile": benchmark_profile_decision_profile,
                    "name": "fixture_resident_cuda_dq_contract"
                    if benchmark_profile_decision_profile is not None
                    else None,
                    "schema_version": 1
                    if benchmark_profile_decision_profile is not None
                    else None,
                ...
                "phase2_acceptance": {
                    "present": benchmark_profile_phase2_profile is not None,
                    "ready": (
                        benchmark_profile_phase2_profile
                        == RESIDENT_CUDA_DQ_PROFILE_NAME
                    ),
                    "source": "profile",
                    "path": None,
                    "profile": benchmark_profile_phase2_profile,
                    "name": "fixture_resident_cuda_dq_contract"
                    if benchmark_profile_phase2_profile is not None
                    else None,
                    "schema_version": 1
                    if benchmark_profile_phase2_profile is not None
                    else None,
                ...
                "default_route": {
                    ...
                    "source": "profile",
                    "path": None,
                    "profile": benchmark_profile_default_route_profile,
                    "name": "fixture_resident_cuda_dq_contract"
                    if benchmark_profile_default_route_profile is not None
                    else None,
                    "schema_version": 1
                    if benchmark_profile_default_route_profile is not None
                    else None,
    ...
    if include_release_decision_release_quality_publication_guard:
        ...
        payload["release_decision_release_quality_publication_guard"] = {
            ...
            "ready": release_decision_release_quality_chain_ready,
            "decision_check_passed": release_decision_release_quality_chain_ready,
            "status": "passed"
            if release_decision_release_quality_chain_ready
            else "blocked",
            "passed": release_decision_release_quality_chain_ready,
            "checks_passed": release_decision_release_quality_chain_ready,
            "compatible_missing": (
            ...
            "final_fields_present": (
                include_release_decision_release_quality_publication_final_checks
                or include_phase2_release_decision_release_quality_publication_final_checks
            ),
            "final_checks_compatible_missing": (
                release_decision_release_quality_final_checks_compatible_missing
            ),
            "final_checks_ready": release_decision_release_quality_final_checks_ready,
            "final_checks_match": release_decision_release_quality_final_checks_match,
            "raw_final_checks_present": (
                include_release_decision_release_quality_publication_final_checks
            ),
            "raw_final_checks_ready": (
                release_decision_release_quality_publication_final_checks_ready
                if include_release_decision_release_quality_publication_final_checks
                else None
            ),
            "phase2_final_checks_present": (
                include_phase2_release_decision_release_quality_publication_final_checks
            ...
            "phase2_final_checks_ready": (
                phase2_release_decision_release_quality_publication_final_checks_ready
                if include_phase2_release_decision_release_quality_publication_final_checks
                else None
            ),
            "decision_check_ready": release_decision_release_quality_chain_ready,
            "checks_ready": release_decision_release_quality_chain_ready,
            "layers_ready": release_decision_release_quality_chain_ready,
...
def test_windows_release_matrix_passes_blackwell_default(tmp_path: Path):
    ...
    assert payload["default_runtime"]["resident_runtime_preset"] == "throughput-v4-native-completion"
    ...
    assert checks["release_decision_benchmark_contract_profile_passed"] is True
    assert (
        checks["default_promotion_benchmark_contract_profile_handoff_passed"]
        is True
    )
    assert payload["release_decision_benchmark_contract_profile"][
        "profile"
    ] == RESIDENT_CUDA_DQ_PROFILE_NAME
...
def test_windows_release_matrix_blocks_release_decision_benchmark_profile_drift(
    tmp_path: Path,
):
    doctor = tmp_path / "doctor.json"
    decision = tmp_path / "decision.json"
    ...
    assert checks["release_decision_benchmark_contract_profile_passed"][
        "passed"
    ] is False
    assert "release_decision_benchmark_contract_profile_passed" in payload[
        "failed_checks"
    ]
    assert checks["release_decision_benchmark_contract_profile_passed"][
        "evidence"
...
def test_windows_release_matrix_blocks_default_promotion_benchmark_handoff_drift(
    tmp_path: Path,
):
    doctor = tmp_path / "doctor.json"
    decision = tmp_path / "decision.json"
    ...
    _default_promotion(
        default_promotion,
        benchmark_profile_handoff_ready=False,
    ...
    checks = {item["name"]: item for item in payload["checks"]}
    handoff = checks["default_promotion_benchmark_contract_profile_handoff_passed"]
    assert payload["passed"] is False
    assert payload["status"] == "blocked"
    assert handoff["passed"] is False
    assert "default_promotion_benchmark_contract_profile_handoff_passed" in payload[
        "failed_checks"
    ]
    assert handoff["evidence"]["decision_profile"] == "legacy_profile"
    assert handoff["evidence"]["phase2_profile"] == RESIDENT_CUDA_DQ_PROFILE_NAME
    assert handoff["evidence"][
        "default_route_profile"
    ] == RESIDENT_CUDA_DQ_PROFILE_NAME
    assert handoff["evidence"]["profiles_agree"] is False
...
def test_windows_release_matrix_allows_compatible_missing_release_quality_final_checks(
    tmp_path: Path,
):
    doctor = tmp_path / "doctor.json"
    decision = tmp_path / "decision.json"
    ...
    assert evidence["final_checks_compatible_missing"] is True
    assert evidence["raw_final_checks_present"] is False
...
def test_windows_release_matrix_carries_release_quality_final_evidence(
    ...
    assert guard["phase2_matrix_final_evidence_ready"] is True
    ...
    assert evidence["direct_final_evidence_detail_fields_present"] is True
    assert evidence["final_evidence_ready"] is True
    assert evidence["final_evidence_detail_ready"] is True
    assert evidence["final_evidence_detail_preserved"] is True
    assert evidence["raw_matrix_final_checks_ready"] is True
    assert evidence["phase2_matrix_final_checks_ready"] is True
    assert evidence["raw_matrix_final_evidence_ready"] is True
    assert evidence["phase2_matrix_final_evidence_ready"] is True
...
def test_windows_release_matrix_allows_legacy_release_quality_without_final_evidence(
    ...
    assert evidence["direct_final_evidence_detail_fields_present"] is False
    assert evidence["final_evidence_detail_fields_present"] is None
    assert evidence["final_evidence_detail_preserved"] is True


def test_windows_release_matrix_allows_legacy_release_quality_final_evidence_without_detail(
    tmp_path: Path,
):
    doctor = tmp_path / "doctor.json"
    decision = tmp_path / "decision.json"
    ...
    payload = read_json(default_promotion)
    _clear_release_quality_final_evidence_detail(
        payload["release_decision_release_quality_publication_guard"]
    )
    write_json(default_promotion, payload)
...
def test_windows_release_matrix_blocks_failed_release_quality_final_checks(
    tmp_path: Path,
):
    doctor = tmp_path / "doctor.json"
    decision = tmp_path / "decision.json"
...
def test_windows_release_matrix_blocks_failed_release_quality_final_evidence_detail(
    tmp_path: Path,
):
    doctor = tmp_path / "doctor.json"
    decision = tmp_path / "decision.json"
...
def test_windows_release_matrix_blocks_missing_default_promotion_release_quality_final_checks(
    tmp_path: Path,
):
    doctor = tmp_path / "doctor.json"
    decision = tmp_path / "decision.json"
    ...
    assert evidence["direct_final_fields_present"] is True
    assert evidence["final_checks_compatible_missing"] is True
    assert evidence["raw_final_checks_present"] is False
    assert evidence["phase2_final_checks_present"] is False


def test_windows_release_matrix_blocks_failed_default_promotion_release_quality_final_checks(
    tmp_path: Path,
):
    doctor = tmp_path / "doctor.json"
    decision = tmp_path / "decision.json"
...
def test_windows_release_matrix_blocks_failed_default_promotion_release_quality_final_evidence(
    ...
    assert evidence["final_evidence_detail_preserved"] is False


def test_windows_release_matrix_blocks_default_promotion_release_quality_final_evidence_detail_loss(
    tmp_path: Path,
):
    doctor = tmp_path / "doctor.json"
    decision = tmp_path / "decision.json"
    ...
    assert evidence["final_evidence_detail_fields_present"] is False
    assert evidence["final_evidence_detail_preserved"] is False
    assert evidence["raw_matrix_final_evidence_ready"] is None
...
def test_windows_release_matrix_cli_writes_json_and_markdown(tmp_path: Path):
    ...
    assert (
        "Benchmark profile handoff: ready=`True` "
        "required=`resident_cuda_dq_v1` agreement=`True`"
    ) in markdown_text
    assert (
        "Benchmark profiles: release=`resident_cuda_dq_v1` "
        "default-decision=`resident_cuda_dq_v1` "

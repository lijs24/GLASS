...
- PASS: `latest_checkpoint_green` - {'gate': 272, 'status': 'green', 'green': True}
...
- PASS: `default_route_acceptance_present` - {'path': 'runs\\checkpoints\\s2_gate_272_default_route_acceptance_fixture.json', 'status': 'passed'}

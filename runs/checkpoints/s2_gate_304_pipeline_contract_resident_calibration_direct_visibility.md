...
- status `passed`, masters `3`, master StackEngine `0`, master resident `3`, legacy masters `0`, integration outputs `1`, integration StackEngine `0`, resident outputs `1`, explicit CUDA fast paths `0`

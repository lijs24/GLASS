...
- PASS: `doctor_schema_version` - {'actual': 1, 'required': 1, 'path': 'GATE289_FIXTURE\\doctor.json'}
...
- PASS: `acceptance_audit_passed` - {'status': 'passed', 'path': 'GATE289_FIXTURE\\acceptance.json'}

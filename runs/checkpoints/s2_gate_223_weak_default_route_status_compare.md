...
- Status: regressed
- Baseline: runs\checkpoints\s2_gate_221_phase2_status.json
- Candidate: runs\checkpoints\s2_gate_223_weak_default_route_phase2_status.json

## Summary

- Baseline: {'status': 'green', 'latest_gate': 221, 'acceptance_status': 'passed', 'cuda_available': True, 'release_manifest_status': 'release_manifest_ready', 'github_release_plan_status': 'release_plan_ready', 'pipeline_contract_status': 'passed', 'pipeline_contract_passed': True, 'release_decision_status': 'default_change_ready', 'default_change_ready': True}
- Candidate: {'status': 'attention_required', 'latest_gate': 222, 'acceptance_status': 'passed', 'cuda_available': True, 'release_manifest_status': 'release_manifest_ready', 'github_release_plan_status': 'release_plan_ready', 'pipeline_contract_status': 'passed', 'pipeline_contract_passed': True, 'release_decision_status': 'default_change_ready', 'default_change_ready': True}
...
- PASS: latest_checkpoint_gate_not_decreased - {'baseline': 221, 'candidate': 222}
...
- FAIL: resident_registration_fastpath_contract_passed_preserved - {'baseline': 'passed', 'candidate': 'not_requested'}
- FAIL: resident_registration_fastpath_contract_check_count_preserved - {'baseline': 24, 'candidate': 0}

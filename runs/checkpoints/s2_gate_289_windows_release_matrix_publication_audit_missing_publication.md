...
- StackEngine publication audit: ready=`None` passed=`None` phase2-check=`None` failed=`None`
...
- PASS: `doctor_schema_version` - {'actual': 1, 'required': 1, 'path': 'GATE289_FIXTURE\\missing_publication\\doctor.json'}
...
- FAIL: `default_promotion_stack_engine_publication_audit_passed` - {'present': None, 'ready': None, 'status': None, 'passed': None, 'phase2_check_passed': None, 'recommendation': None, 'check_count': None, 'failed_check_count': None, 'failed_checks': []}
...
- PASS: `acceptance_audit_passed` - {'status': 'passed', 'path': 'GATE289_FIXTURE\\missing_publication\\acceptance.json'}

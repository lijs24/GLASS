...
- PASS: `latest_checkpoint_green` - {'gate': 309, 'status': 'green', 'green': True}
...
- PASS: `phase2_embeds_same_release_decision` - {'input': 'runs\\checkpoints\\s2_gate_309_release_decision_direct_runtime_publication_guard.json', 'phase2_release_decision_path': 'runs\\checkpoints\\s2_gate_309_release_decision_direct_runtime_publication_guard.json'}

...
- PASS: `acceptance_audit_passed` - {'status': 'passed', 'path': 'runs\\checkpoints\\s2_gate_366_fixtures\\phase2_quality_mismatch\\acceptance.json'}

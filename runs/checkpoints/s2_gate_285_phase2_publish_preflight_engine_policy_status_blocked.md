...
- Integration engine policy statuses: matrix-ready=None, matrix-acceptance=None, matrix-pipeline=None, default-promotion-ready=None, default-promotion-acceptance=None, default-promotion-pipeline=None
- Integration engine policy checks: matrix-acceptance=None, matrix-pipeline=None, default-promotion-acceptance=None, default-promotion-pipeline=None, agreement=None
...
- FAIL: windows_publish_preflight_integration_engine_policy_passed - {'matrix_ready': None, 'matrix_acceptance_status': None, 'matrix_pipeline_status': None, 'default_promotion_ready': None, 'default_promotion_acceptance_status': None, 'default_promotion_pipeline_status': None, 'matrix_acceptance_check': None, 'matrix_pipeline_check': None, 'default_promotion_acceptance_check': None, 'default_promotion_pipeline_check': None, 'agreement_check': None, 'failed_checks': []}

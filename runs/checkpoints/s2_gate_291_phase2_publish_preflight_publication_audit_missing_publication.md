...
- Checkpoint path: GATE291_FIXTURE\missing_publication\checkpoints\s2_gate_291_status.md
...
- StackEngine publication audit statuses: matrix=None/None, default-promotion=None/None
- StackEngine publication audit chains: matrix-policy=None, matrix-resident-winsorized=None, default-policy=None, default-resident-winsorized=None
- StackEngine publication audit checks: matrix-audit=None, matrix-policy=None, matrix-resident-winsorized=None, default-audit=None, default-policy=None, default-resident-winsorized=None, agreement=None
...
- FAIL: windows_publish_preflight_stack_engine_publication_audit_passed - {'matrix_status': None, 'matrix_ready': None, 'matrix_policy_agreement': None, 'matrix_resident_winsorized_agreement': None, 'default_promotion_status': None, 'default_promotion_ready': None, 'default_promotion_policy_agreement': None, 'default_promotion_resident_winsorized_agreement': None, 'matrix_audit_check': None, 'matrix_policy_check': None, 'matrix_resident_winsorized_check': None, 'default_promotion_audit_check': None, 'default_promotion_policy_check': None, 'default_promotion_resident_winsorized_check': None, 'agreement_check': None, 'failed_checks': []}

...
- Tag: `s2-gate-341`
- Title: `GLASS S2 Gate 341 Release Plan`
- Source stamps: `s2-gate-341`
- GitHub CLI available: `False`
- GitHub CLI auth OK: `False`
- Publish script: `C:\Users\ljs\WORK\astro\gpuwbpp\runs\checkpoints\s2_gate_341_publish_release_passed.ps1`
...
- Matrix path: `runs\checkpoints\s2_gate_340_windows_release_matrix_passed.json`
...
- Resident result contract: ready=`True` status=`passed` phase2=`True` required=`1` failed=`0`
...
- PASS: `windows_release_matrix_present` - {'path': 'runs\\checkpoints\\s2_gate_340_windows_release_matrix_passed.json', 'required': True}
...
- PASS: `windows_release_matrix_resident_result_contract_handoff_passed` - {'present': True, 'ready': True, 'status': 'passed', 'top_level_check': True, 'check_present': True, 'check_passed': True, 'phase2_check_passed': True, 'required_count': 1, 'failed_count': 0, 'failed_check_count': 0, 'failed_checks': [], 'failed_items': []}

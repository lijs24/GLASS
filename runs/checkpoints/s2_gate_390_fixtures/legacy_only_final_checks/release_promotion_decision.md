...
- PASS: `acceptance_audit_passed` - {'status': 'passed', 'path': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_390_fixtures\\legacy_only_final_checks\\acceptance_audit.json'}
...
- Release quality raw final evidence detail: matrix=`None` phase2=`None`

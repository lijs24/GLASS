...
- PASS: `acceptance_audit_passed` - {'status': 'passed', 'path': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_390_fixtures\\failed_raw_matrix_phase2_final_evidence_detail\\acceptance_audit.json'}
...
- Release quality raw final evidence detail: matrix=`True` phase2=`False`
- Release quality Phase2 final evidence detail: matrix=`True` phase2=`True`

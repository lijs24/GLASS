...
- Release quality compare publication guard: ready=`True` check=`None` quality-present=`False` compatible-missing=`True`
- Release quality compare sources: raw=`None` phase2=`None` raw-failed=`None` phase2-failed=`None`
...
- PASS: `phase2_embeds_same_release_decision` - {'input': 'runs\\checkpoints\\s2_gate_367_fixtures\\missing_quality_guard\\decision.json', 'phase2_release_decision_path': 'runs\\checkpoints\\s2_gate_367_fixtures\\missing_quality_guard\\decision.json'}

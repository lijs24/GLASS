# GLASS Gate274 publish preflight dry run
...
- Default route contract: `True` checks `4` speedup `58.099101701945926`
...
- Runtime repeat evidence: runs `None`, best `None` `None` s, ratio `1.053510511049479`
- Phase 2 status compare: `passed` baseline `270` candidate `271`

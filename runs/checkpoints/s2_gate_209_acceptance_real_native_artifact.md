...
- Pipeline contract path: C:\glass_runs\phase2_s2_gate_209_native_artifact\guardrails\pipeline_contract.json
...
- PASS: pipeline_contract_present - {'path': 'C:\\glass_runs\\phase2_s2_gate_209_native_artifact\\guardrails\\pipeline_contract.json', 'exists': True, 'audit_type': 'pipeline_invariant_contract'}
- PASS: pipeline_contract_passed - {'status': 'passed', 'failed_checks': []}
- PASS: contract_pipeline_contract_present - {'required': True, 'present': True, 'path': 'C:\\glass_runs\\phase2_s2_gate_209_native_artifact\\guardrails\\pipeline_contract.json'}
...
- Status: passed
- Required by benchmark contract: True
- StackEngine contract path: C:\glass_runs\phase2_s2_gate_209_native_artifact\guardrails\stack_engine_contract.json
...
- PASS: stack_engine_contract_present - {'path': 'C:\\glass_runs\\phase2_s2_gate_209_native_artifact\\guardrails\\stack_engine_contract.json', 'exists': True, 'audit_type': 'stack_engine_default_contract'}
- PASS: stack_engine_contract_passed - {'status': 'passed', 'failed_checks': []}
- PASS: contract_stack_engine_default_promotion_present - {'required': True, 'present': True, 'path': 'C:\\glass_runs\\phase2_s2_gate_209_native_artifact\\guardrails\\stack_engine_contract.json'}
...
- PASS: contract_bundle_present - {'path': 'C:\\glass_runs\\phase2_s2_gate_209_native_artifact\\guardrails\\acceptance_contract_bundle.json', 'exists': True}
- PASS: contract_bundle_type - {'path': 'C:\\glass_runs\\phase2_s2_gate_209_native_artifact\\guardrails\\acceptance_contract_bundle.json', 'artifact_type': 'glass_acceptance_contract_bundle', 'required': 'glass_acceptance_contract_bundle'}

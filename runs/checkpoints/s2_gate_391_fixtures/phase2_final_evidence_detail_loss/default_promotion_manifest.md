...
- Release quality publication final evidence detail: ready=`False` raw-matrix=`True` raw-phase2=`True` phase2-matrix=`None` phase2-phase2=`None`
...
- PASS: `phase2_embeds_same_release_decision` - {'input': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_391_fixtures\\phase2_final_evidence_detail_loss\\release_promotion_decision.json', 'phase2_release_decision_path': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_391_fixtures\\phase2_final_evidence_detail_loss\\release_promotion_decision.json'}

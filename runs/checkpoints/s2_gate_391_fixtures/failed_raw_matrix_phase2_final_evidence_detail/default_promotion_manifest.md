...
- Release quality publication guard: ready=`False` check=`True` guard-present=`True` compatible-missing=`False`
...
- Release quality publication final evidence: ready=`True` match=`True` compatible-missing=`False` raw-present=`True` phase2-present=`True`
- Release quality publication final evidence detail: ready=`False` raw-matrix=`True` raw-phase2=`False` phase2-matrix=`True` phase2-phase2=`True`
...
- PASS: `phase2_embeds_same_release_decision` - {'input': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_391_fixtures\\failed_raw_matrix_phase2_final_evidence_detail\\release_promotion_decision.json', 'phase2_release_decision_path': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_391_fixtures\\failed_raw_matrix_phase2_final_evidence_detail\\release_promotion_decision.json'}

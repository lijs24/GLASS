...
$ExpectedTag = 'v0.1.0-phase2-gate214'
$ReleaseTitle = 'GLASS Phase 2 Gate 214 Windows packages'
$NotesFile = 'C:\Users\ljs\WORK\astro\gpuwbpp\runs\checkpoints\s2_gate_214_release_notes.md'
$Phase2StatusFile = 'runs\checkpoints\s2_gate_214_phase2_status.json'
$Phase2StatusCompareFile = 'runs\checkpoints\s2_gate_214_phase2_status_compare.json'
$Assets = @(

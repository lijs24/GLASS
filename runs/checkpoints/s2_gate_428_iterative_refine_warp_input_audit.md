...
- Resident-matrix resident warp RMS: `{'count': 8, 'max': 0.19636857820971282, 'mean': 0.11609218147802008}`
- Matrix translation delta px: `{'count': 8, 'max': 0.009531948948220055, 'mean': 0.005341946665079382}`
...
- PASS: `resident_matrix_warp_delta_attributed` - {'max_rms': 0.19636857820971282, 'tolerance': 0.1, 'resident_matrix_warp_parity_passed': False, 'matrix_translation_delta_px_max': 0.009531948948220055}

## Worst Frames

| frame | matrix delta px | cpu-matrix RMS | resident-matrix RMS |
| --- | ---: | ---: | ---: |
| `F000013` | 0.004725407071340635 | 0.0002643936071558697 | 0.19636857820971282 |
...
| `F000014` | 0.004984945900102095 | 0.00018421133289196341 | 0.10813373765303515 |

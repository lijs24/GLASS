...
- Status: green
- Latest checkpoint: S2-Gate 370 (green)
- Checkpoint path: C:\Users\ljs\WORK\astro\gpuwbpp\runs\checkpoints\s2_gate_370_fixtures\missing_release_quality_guard\checkpoints\s2_gate_370_status.md
...
- Release quality publication guard evidence: matrix=None/None/None/None, matrix-default=None/None/None, default=None/None/None/None
- Release quality publication guard checks: matrix=None, matrix-default=None, default=None, matrix-default-match=None, matrix-manifest-match=None
...
- PASS: latest_checkpoint_green - {'gate': 370, 'status': 'green'}
...
- PASS: windows_publish_preflight_release_quality_publication_guard_passed - {'present': False, 'matrix_present': None, 'matrix_ready': None, 'matrix_check_passed': None, 'matrix_layers_ready': None, 'matrix_raw_status': None, 'matrix_phase2_status': None, 'matrix_default_ready': None, 'matrix_default_raw_status': None, 'matrix_default_phase2_status': None, 'default_promotion_present': None, 'default_promotion_ready': None, 'default_promotion_check_passed': None, 'default_promotion_layers_ready': None, 'default_promotion_raw_status': None, 'default_promotion_phase2_status': None, 'matrix_check': None, 'matrix_default_check': None, 'default_promotion_check': None, 'matrix_default_match_check': None, 'matrix_manifest_match_check': None, 'failed_checks': []}

...
- StackEngine runtime default: ready=`False` acceptance=`passed` pipeline=`failed`
- Runtime default counts: acceptance-legacy=`0` acceptance-failed-masters=`0` pipeline-failed-outputs=`1` explicit-cuda=`1`
...
- PASS: `doctor_schema_version` - {'actual': 1, 'required': 1, 'path': 'runs\\checkpoints\\s2_gate_296_fixtures\\pipeline_runtime_default_failed\\doctor.json'}
...
- FAIL: `default_promotion_pipeline_stack_engine_runtime_default_passed` - {'status': 'failed', 'check_present': True, 'check_passed': False, 'phase2_check_passed': False, 'master_count': 3, 'legacy_master_count': 0, 'failed_master_count': 0, 'failed_output_count': 1, 'explicit_cuda_fast_path_count': 1, 'failed_masters': [], 'failed_outputs': [{'engine_family': 'legacy', 'item': 'H', 'reason': 'legacy_or_unknown_engine'}]}

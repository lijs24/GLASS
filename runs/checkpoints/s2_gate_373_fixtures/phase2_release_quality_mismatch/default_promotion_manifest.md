...
- Release quality publication sources: raw-status=`passed` phase2-status=`failed` raw-phase2=`passed` phase2-phase2=`attention_required`
...
- PASS: `phase2_embeds_same_release_decision` - {'input': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_373_fixtures\\phase2_release_quality_mismatch\\release_decision.json', 'phase2_release_decision_path': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_373_fixtures\\phase2_release_quality_mismatch\\release_decision.json'}
...
- FAIL: `release_decision_release_quality_publication_guard_passed` - {'present': True, 'ready': False, 'decision_check_passed': False, 'status': 'passed', 'passed': False, 'checks_passed': False, 'compatible_missing': False, 'release_quality_guard_present': True, 'decision_check_ready': False, 'checks_ready': False, 'layers_ready': False, 'raw_present': True, 'raw_ready': True, 'raw_matrix_raw_status': 'passed', 'raw_matrix_phase2_status': 'passed', 'raw_matrix_check_passed': True, 'raw_matrix_layers_ready': True, 'raw_default_promotion_raw_status': 'passed', 'raw_default_promotion_phase2_status': 'passed', 'raw_default_promotion_check_passed': True, 'raw_default_promotion_layers_ready': True, 'raw_matrix_check': True, 'raw_matrix_default_check': True, 'raw_default_promotion_check': True, 'raw_matrix_default_match_check': True, 'raw_matrix_manifest_match_check': True, 'phase2_present': True, 'phase2_ready': False, 'phase2_check_passed': False, 'phase2_matrix_raw_status': 'failed', 'phase2_matrix_phase2_status': 'attention_required', 'phase2_matrix_check_passed': False, 'phase2_matrix_layers_ready': False, 'phase2_default_promotion_raw_status': 'failed', 'phase2_default_promotion_phase2_status': 'attention_required', 'phase2_default_promotion_check_passed': False, 'phase2_default_promotion_layers_ready': False, 'phase2_matrix_check': False, 'phase2_matrix_default_check': False, 'phase2_default_promotion_check': False, 'phase2_matrix_default_match_check': False, 'phase2_matrix_manifest_match_check': False, 'failed_checks': ['stack_engine_publication_release_quality_guard_passed']}

...
- Release quality publication guard: ready=`True` check=`None` guard-present=`False` compatible-missing=`True`
- Release quality publication sources: raw-status=`None` phase2-status=`None` raw-phase2=`None` phase2-phase2=`None`
...
- PASS: `phase2_embeds_same_release_decision` - {'input': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_373_fixtures\\missing_release_quality_guard\\release_decision.json', 'phase2_release_decision_path': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_373_fixtures\\missing_release_quality_guard\\release_decision.json'}
...
- PASS: `release_decision_release_quality_publication_guard_passed` - {'present': False, 'ready': True, 'decision_check_passed': None, 'status': None, 'passed': None, 'checks_passed': None, 'compatible_missing': True, 'release_quality_guard_present': False, 'decision_check_ready': True, 'checks_ready': True, 'layers_ready': True, 'raw_present': None, 'raw_ready': None, 'raw_matrix_raw_status': None, 'raw_matrix_phase2_status': None, 'raw_matrix_check_passed': None, 'raw_matrix_layers_ready': None, 'raw_default_promotion_raw_status': None, 'raw_default_promotion_phase2_status': None, 'raw_default_promotion_check_passed': None, 'raw_default_promotion_layers_ready': None, 'raw_matrix_check': None, 'raw_matrix_default_check': None, 'raw_default_promotion_check': None, 'raw_matrix_default_match_check': None, 'raw_matrix_manifest_match_check': None, 'phase2_present': None, 'phase2_ready': None, 'phase2_check_passed': None, 'phase2_matrix_raw_status': None, 'phase2_matrix_phase2_status': None, 'phase2_matrix_check_passed': None, 'phase2_matrix_layers_ready': None, 'phase2_default_promotion_raw_status': None, 'phase2_default_promotion_phase2_status': None, 'phase2_default_promotion_check_passed': None, 'phase2_default_promotion_layers_ready': None, 'phase2_matrix_check': None, 'phase2_matrix_default_check': None, 'phase2_default_promotion_check': None, 'phase2_matrix_default_match_check': None, 'phase2_matrix_manifest_match_check': None, 'failed_checks': []}

...
- Status: passed
- Baseline: runs\checkpoints\s2_gate_206_phase2_status.json
- Candidate: runs\checkpoints\s2_gate_207_phase2_status.json

## Summary

- Baseline: {'status': 'green', 'latest_gate': 206, 'acceptance_status': 'passed', 'cuda_available': True, 'release_manifest_status': 'release_manifest_ready', 'github_release_plan_status': 'release_plan_ready'}
- Candidate: {'status': 'green', 'latest_gate': 207, 'acceptance_status': 'passed', 'cuda_available': True, 'release_manifest_status': 'release_manifest_ready', 'github_release_plan_status': 'release_plan_ready'}
...
- PASS: latest_checkpoint_gate_not_decreased - {'baseline': 206, 'candidate': 207}

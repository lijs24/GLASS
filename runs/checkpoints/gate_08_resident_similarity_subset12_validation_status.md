...
- Output run: `C:\gpwbpp_runs\final_m38_h_200\gpwbpp_resident_similarity_catalog_subset12_starcore8`
- Report: `C:\gpwbpp_runs\final_m38_h_200\gpwbpp_resident_similarity_catalog_subset12_starcore8\report.html`
...
- This is a validation checkpoint, not the final 200-light WBPP-vs-GPWBPP benchmark.
...
- The validation used user-provided astronomical image data and GPWBPP's clean-room resident CUDA registration path.

...
- PASS: `acceptance_audit_passed` - {'status': 'passed', 'path': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_384_fixtures\\failed_phase2_final_evidence\\acceptance.json'}
...
- Release quality guard ready: `False`
- Release quality guard present: `True`
- Release quality final checks ready: `True`
- Release quality final checks match: `True`
- Release quality final evidence ready: `False`
- Release quality final evidence match: `False`
...
- Release quality raw final evidence: present=`True` matrix=`True` phase2=`True`
- Release quality Phase2 final evidence: present=`True` matrix=`False` phase2=`False`

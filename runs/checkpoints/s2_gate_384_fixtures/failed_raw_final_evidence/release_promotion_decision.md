...
- PASS: `acceptance_audit_passed` - {'status': 'passed', 'path': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_384_fixtures\\failed_raw_final_evidence\\acceptance.json'}
...
- Release quality raw final evidence: present=`True` matrix=`False` phase2=`False`
- Release quality Phase2 final evidence: present=`True` matrix=`True` phase2=`True`

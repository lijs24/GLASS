...
- Zip: `C:\Users\ljs\WORK\astro\gpuwbpp\.release\windows\GLASS-Portable-win64-cpu.zip`
- Zip size bytes: `296215418`
...
- PASS: `portable_zip_exists` - {'path': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\.release\\windows\\GLASS-Portable-win64-cpu.zip'}
- PASS: `portable_zip_nonempty` - {'path': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\.release\\windows\\GLASS-Portable-win64-cpu.zip', 'size_bytes': 296215418}
- PASS: `package_label_matches_expected` - {'actual': 'cpu', 'required': 'cpu'}
- PASS: `source_stamp_matches_expected` - {'actual': 'a1604b0', 'required': 'a1604b0'}

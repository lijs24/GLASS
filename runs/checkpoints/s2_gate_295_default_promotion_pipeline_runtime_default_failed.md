...
- Pipeline StackEngine runtime default: `failed` check=`False` legacy=`0` failed-masters=`0` failed-outputs=`1`
...
- PASS: `phase2_embeds_same_release_decision` - {'input': 'runs\\checkpoints\\s2_gate_295_fixtures\\pipeline_runtime_default_failed\\release_decision.json', 'phase2_release_decision_path': 'runs\\checkpoints\\s2_gate_295_fixtures\\pipeline_runtime_default_failed\\release_decision.json'}

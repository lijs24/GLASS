...
- Pipeline contract path: runs\checkpoints\s2_gate_294_fixtures\acceptance\pipeline_ready.json
...
- PASS: pipeline_contract_present - {'path': 'runs\\checkpoints\\s2_gate_294_fixtures\\acceptance\\pipeline_ready.json', 'exists': True, 'audit_type': 'pipeline_invariant_contract'}
...
- PASS: pipeline_contract_stack_engine_runtime_default - {'status': 'passed', 'check_present': True, 'check_passed': True, 'master_count': 1, 'legacy_master_count': 0, 'integration_output_count': 1, 'explicit_cuda_fast_path_count': 0, 'failed_masters': [], 'failed_outputs': []}

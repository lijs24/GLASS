...
- FAIL: `pipeline_rejection_sample_accounting_passed` - {'ready': False, 'check': None, 'status': 'failed', 'check_present': False, 'required_count': 1, 'verified_count': 0, 'accounted_output_count': 0, 'failed_count': 1, 'failed_items': [{'item': 'H', 'status': 'missing_required', 'accounting_present': False, 'required': True, 'verified': False, 'ok': False, 'map_rejected_sample_sum': None, 'source_counts': [], 'failed_matches': [], 'required_maps': ['low_rejection', 'high_rejection'], 'verified_maps': ['low_rejection', 'high_rejection']}], 'scope': 'required'}
- FAIL: `pipeline_sample_accounting_closure_passed` - {'ready': False, 'check': None, 'status': 'not_available', 'check_present': False, 'present_count': 0, 'required_count': 0, 'failed_count': 0, 'failed_items': [], 'scope': 'not_required'}
...
- Rejection sample accounting: `failed`
- Rejection sample release scope: `required`, ready `False`, required `1`, verified `0`
- Sample accounting closure: `not_available`
- Sample closure release scope: `not_required`, ready `False`, required `0`, present `0`

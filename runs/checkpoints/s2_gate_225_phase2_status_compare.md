...
- Status: passed
- Baseline: runs\checkpoints\s2_gate_224_phase2_status.json
- Candidate: runs\checkpoints\s2_gate_225_phase2_status.json

## Summary

- Baseline: {'status': 'green', 'latest_gate': 224, 'acceptance_status': 'passed', 'default_route_acceptance_status': 'passed', 'default_route_acceptance_passed': True, 'cuda_available': True, 'release_manifest_status': 'release_manifest_ready', 'github_release_plan_status': 'release_plan_ready', 'pipeline_contract_status': 'passed', 'pipeline_contract_passed': True, 'release_decision_status': 'default_change_ready', 'default_change_ready': True}
- Candidate: {'status': 'green', 'latest_gate': 225, 'acceptance_status': 'passed', 'default_route_acceptance_status': 'passed', 'default_route_acceptance_passed': True, 'cuda_available': True, 'release_manifest_status': 'release_manifest_ready', 'github_release_plan_status': 'release_plan_ready', 'pipeline_contract_status': 'passed', 'pipeline_contract_passed': True, 'release_decision_status': 'default_change_ready', 'default_change_ready': True}
...
- PASS: latest_checkpoint_gate_not_decreased - {'baseline': 224, 'candidate': 225}

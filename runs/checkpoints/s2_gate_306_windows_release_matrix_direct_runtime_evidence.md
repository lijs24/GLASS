...
- PASS: `doctor_schema_version` - {'actual': 1, 'required': 1, 'path': 'runs\\checkpoints\\s2_gate_306_doctor.json'}
...
- PASS: `default_promotion_stack_engine_publication_audit_passed` - {'present': True, 'ready': True, 'status': 'passed', 'passed': True, 'phase2_check_passed': True, 'recommendation': 'publication_chain_ready', 'check_count': 28, 'failed_check_count': 0, 'failed_checks': []}

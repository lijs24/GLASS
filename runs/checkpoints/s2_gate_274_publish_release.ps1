...
$ExpectedTag = 'v0.1.0-gate274-preflight'
$ReleaseTitle = 'GLASS Gate274 publish preflight dry run'
$NotesFile = 'C:\Users\ljs\WORK\astro\gpuwbpp\runs\checkpoints\s2_gate_274_github_release_notes.md'
$WindowsReleaseMatrixFile = 'runs\checkpoints\s2_gate_273_windows_release_matrix.json'
$Phase2StatusFile = 'runs\checkpoints\s2_gate_272_phase2_status_fixture.json'
$Phase2StatusCompareFile = 'runs\checkpoints\s2_gate_271_phase2_status_compare.json'
$Assets = @(

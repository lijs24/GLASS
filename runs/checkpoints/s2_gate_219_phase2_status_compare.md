...
- Status: passed
- Baseline: runs\checkpoints\s2_gate_218_phase2_status.json
- Candidate: runs\checkpoints\s2_gate_219_phase2_status.json

## Summary

- Baseline: {'status': 'green', 'latest_gate': 218, 'acceptance_status': 'passed', 'cuda_available': True, 'release_manifest_status': 'release_manifest_ready', 'github_release_plan_status': 'release_plan_ready', 'pipeline_contract_status': 'passed', 'pipeline_contract_passed': True, 'release_decision_status': None, 'default_change_ready': None}
- Candidate: {'status': 'green', 'latest_gate': 219, 'acceptance_status': 'passed', 'cuda_available': True, 'release_manifest_status': 'release_manifest_ready', 'github_release_plan_status': 'release_plan_ready', 'pipeline_contract_status': 'passed', 'pipeline_contract_passed': True, 'release_decision_status': 'default_change_ready', 'default_change_ready': True}
...
- PASS: latest_checkpoint_gate_not_decreased - {'baseline': 218, 'candidate': 219}
...
- PASS: release_decision_default_change_ready_preserved - {'baseline': None, 'candidate': True}
- PASS: release_decision_promote_recommendation_preserved - {'baseline': None, 'candidate': 'promote_default_candidate'}

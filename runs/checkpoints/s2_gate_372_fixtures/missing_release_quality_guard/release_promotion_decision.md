...
- PASS: `acceptance_audit_passed` - {'status': 'passed', 'path': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_372_fixtures\\missing_release_quality_guard\\acceptance.json'}
...
- PASS: `stack_engine_publication_release_quality_guard_passed` - {'present': True, 'artifact_type': 'stack_engine_publication_audit', 'status': 'passed', 'passed': True, 'recommendation': 'publication_chain_ready', 'failed_checks': [], 'checks': {'publish_preflight_release_quality_publication_guard_ready': None, 'phase2_publish_preflight_release_quality_publication_guard_ready': None, 'phase2_publish_preflight_release_quality_publication_guard_matches_publish_preflight': None}, 'checks_passed': True, 'ready': True, 'compatible_missing': True, 'release_quality_guard_present': False, 'raw_present': None, 'raw_ready': None, 'raw_matrix_present': None, 'raw_matrix_ready': None, 'raw_matrix_check_passed': None, 'raw_matrix_layers_ready': None, 'raw_matrix_raw_status': None, 'raw_matrix_phase2_status': None, 'raw_matrix_default_ready': None, 'raw_matrix_default_raw_status': None, 'raw_matrix_default_phase2_status': None, 'raw_default_promotion_present': None, 'raw_default_promotion_ready': None, 'raw_default_promotion_check_passed': None, 'raw_default_promotion_layers_ready': None, 'raw_default_promotion_raw_status': None, 'raw_default_promotion_phase2_status': None, 'raw_matrix_check': None, 'raw_matrix_default_check': None, 'raw_default_promotion_check': None, 'raw_matrix_default_match_check': None, 'raw_matrix_manifest_match_check': None, 'phase2_present': None, 'phase2_ready': None, 'phase2_check_passed': None, 'phase2_matrix_present': None, 'phase2_matrix_ready': None, 'phase2_matrix_check_passed': None, 'phase2_matrix_layers_ready': None, 'phase2_matrix_raw_status': None, 'phase2_matrix_phase2_status': None, 'phase2_matrix_default_ready': None, 'phase2_matrix_default_raw_status': None, 'phase2_matrix_default_phase2_status': None, 'phase2_default_promotion_present': None, 'phase2_default_promotion_ready': None, 'phase2_default_promotion_check_passed': None, 'phase2_default_promotion_layers_ready': None, 'phase2_default_promotion_raw_status': None, 'phase2_default_promotion_phase2_status': None, 'phase2_matrix_check': None, 'phase2_matrix_default_check': None, 'phase2_default_promotion_check': None, 'phase2_matrix_default_match_check': None, 'phase2_matrix_manifest_match_check': None}

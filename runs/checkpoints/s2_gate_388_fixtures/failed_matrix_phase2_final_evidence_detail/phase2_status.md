...
- Latest checkpoint: S2-Gate 388 (green)
- Checkpoint path: runs\checkpoints\s2_gate_388_fixtures\failed_matrix_phase2_final_evidence_detail\checkpoints\s2_gate_388_status.md
...
- Release quality publication guard final evidence: matrix=True/True/True/True, matrix-default=True/True/True/True, default=True/True/True/True
- Release quality publication guard final evidence detail: matrix=True/True/True/False, matrix-default=True/True/True/True, default=True/True/True/True
...
- PASS: latest_checkpoint_green - {'gate': 388, 'status': 'green'}
...
- FAIL: windows_publish_preflight_release_quality_publication_guard_passed - {'present': True, 'matrix_present': True, 'matrix_ready': True, 'matrix_check_passed': True, 'matrix_layers_ready': True, 'matrix_raw_status': 'passed', 'matrix_phase2_status': 'passed', 'matrix_default_ready': True, 'matrix_default_raw_status': 'passed', 'matrix_default_phase2_status': 'passed', 'default_promotion_present': True, 'default_promotion_ready': True, 'default_promotion_check_passed': True, 'default_promotion_layers_ready': True, 'default_promotion_raw_status': 'passed', 'default_promotion_phase2_status': 'passed', 'matrix_check': True, 'matrix_default_check': True, 'default_promotion_check': True, 'matrix_default_match_check': True, 'matrix_manifest_match_check': True, 'final_checks_present': True, 'final_evidence_present': True, 'final_evidence_detail_present': True, 'final_evidence_passed': False, 'release_matrix_check': True, 'release_matrix_default_check': True, 'release_default_promotion_check': True, 'release_matrix_default_match_check': True, 'release_matrix_manifest_match_check': True, 'matrix_final_checks_ready': True, 'matrix_final_checks_match': True, 'matrix_raw_final_checks_ready': True, 'matrix_phase2_final_checks_ready': True, 'matrix_default_final_checks_ready': True, 'matrix_default_final_checks_match': True, 'matrix_default_raw_final_checks_ready': True, 'matrix_default_phase2_final_checks_ready': True, 'default_promotion_final_checks_ready': True, 'default_promotion_final_checks_match': True, 'default_promotion_raw_final_checks_ready': True, 'default_promotion_phase2_final_checks_ready': True, 'matrix_final_evidence_ready': True, 'matrix_final_evidence_match': True, 'matrix_raw_final_evidence_ready': True, 'matrix_phase2_final_evidence_ready': False, 'matrix_default_final_evidence_ready': True, 'matrix_default_final_evidence_match': True, 'matrix_default_raw_final_evidence_ready': True, 'matrix_default_phase2_final_evidence_ready': True, 'default_promotion_final_evidence_ready': True, 'default_promotion_final_evidence_match': True, 'default_promotion_raw_final_evidence_ready': True, 'default_promotion_phase2_final_evidence_ready': True, 'failed_checks': []}

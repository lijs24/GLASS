...
- PASS: `phase2_embeds_same_release_decision` - {'input': 'GATE288_FIXTURE\\release_decision.json', 'phase2_release_decision_path': 'GATE288_FIXTURE\\release_decision.json'}

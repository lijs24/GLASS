...
- `.\\.venv\\Scripts\\python.exe -m py_compile src/glass/engine/quality.py src/glass/cli.py tests/test_cpu_star_detect.py tests/test_pipeline_fixture.py`
- `.\\.venv\\Scripts\\python.exe -m pytest -q tests/test_cpu_star_detect.py tests/test_pipeline_fixture.py`
- `.\\.venv\\Scripts\\python.exe -m pytest -q`
- `.\\.venv\\Scripts\\glass.exe run --plan runs/real_m5_lum_subset/processing_plan.json --out runs/real_m5_lum_subset/glass_cuda_streaming_quality --backend cuda --until-stage quality --tile-size 1024`
...
- `runs/real_m5_lum_subset/glass_cuda_streaming_quality/frame_quality.json`
- `runs/real_m5_lum_subset/glass_cuda_streaming_quality/calibration_artifacts.json`
- `runs/real_m5_lum_subset/glass_cuda_streaming_quality/run_state.json`

...
- `.\\.venv\\Scripts\\python.exe -m py_compile src/gpwbpp/engine/integration.py tests/test_pipeline_fixture.py`
...
- `.\\.venv\\Scripts\\gpwbpp.exe run --plan runs/real_m5_lum_subset/processing_plan.json --out runs/real_m5_lum_subset/gpwbpp_cuda_streaming_integration --backend cuda --until-stage integration --local-normalization off --integration-weighting none --integration-rejection none --tile-size 1024`
- `.\\.venv\\Scripts\\gpwbpp.exe compare --gpwbpp runs/real_m5_lum_subset/gpwbpp_cuda_streaming_integration/integration/master_Lum.fits --reference runs/real_m5_lum_subset/gpwbpp_cuda_bounded_master_accumulator/integration/master_Lum.fits --out runs/real_m5_lum_subset/gpwbpp_cuda_streaming_integration/compare_vs_bounded_master_accumulator.html`
...
- Compare against previous bounded-master-accumulator GPWBPP output:
  - `shape_match`: true
  - `rms_diff`: 0.0
  - `mean_diff`: 0.0
  - `max_abs_diff`: 0.0
...
- `runs/real_m5_lum_subset/gpwbpp_cuda_streaming_integration/integration_results.json`
- `runs/real_m5_lum_subset/gpwbpp_cuda_streaming_integration/integration/master_Lum.fits`
- `runs/real_m5_lum_subset/gpwbpp_cuda_streaming_integration/compare_vs_bounded_master_accumulator.html`
- `runs/real_m5_lum_subset/gpwbpp_cuda_streaming_integration/compare_vs_bounded_master_accumulator.json`

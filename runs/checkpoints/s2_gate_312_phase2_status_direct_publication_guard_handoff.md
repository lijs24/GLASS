...
- Status: green
- Latest checkpoint: S2-Gate 312 (green)
- Checkpoint path: runs\checkpoints\s2_gate_312_status.md
...
- Release tag: v0.1.0-gate311-preflight
- Assets/packages: 4/4
...
- PASS: latest_checkpoint_green - {'gate': 312, 'status': 'green'}

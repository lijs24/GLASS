...
- Release quality publication final evidence: ready=`False` match=`False` compatible-missing=`False` raw-present=`True` phase2-present=`True`
...
- PASS: `phase2_embeds_same_release_decision` - {'input': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_385_fixtures\\failed_raw_final_evidence\\release_promotion_decision.json', 'phase2_release_decision_path': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_385_fixtures\\failed_raw_final_evidence\\release_promotion_decision.json'}

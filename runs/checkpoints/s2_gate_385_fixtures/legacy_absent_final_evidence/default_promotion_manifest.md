...
- Release quality publication final evidence: ready=`True` match=`True` compatible-missing=`True` raw-present=`None` phase2-present=`None`
...
- PASS: `phase2_embeds_same_release_decision` - {'input': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_385_fixtures\\legacy_absent_final_evidence\\release_promotion_decision.json', 'phase2_release_decision_path': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_385_fixtures\\legacy_absent_final_evidence\\release_promotion_decision.json'}

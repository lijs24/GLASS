...
- StackEngine publication audit: ready=`False` passed=`False` phase2-check=`True` failed=`1`
- Publication policy chain: raw=`True` phase2=`True` agreement=`True` check=`True`
- Publication resident winsorized chain: raw=`False` phase2=`False` agreement=`False` check=`False`
...
- PASS: `doctor_schema_version` - {'actual': 1, 'required': 1, 'path': 'GATE289_FIXTURE\\failed_resident_winsorized\\doctor.json'}
...
- FAIL: `default_promotion_stack_engine_publication_audit_passed` - {'present': True, 'ready': False, 'status': 'failed', 'passed': False, 'phase2_check_passed': True, 'recommendation': 'fix_stack_engine_publication_blockers', 'check_count': 18, 'failed_check_count': 1, 'failed_checks': ['stack_engine_publication_audit_resident_winsorized_chain_passed']}
...
- FAIL: `default_promotion_stack_engine_publication_resident_winsorized_chain_passed` - {'phase2_check_passed': False, 'publish_preflight_resident_winsorized_ready': False, 'phase2_resident_winsorized_ready': False, 'resident_winsorized_agreement': False}
...
- PASS: `acceptance_audit_passed` - {'status': 'passed', 'path': 'GATE289_FIXTURE\\failed_resident_winsorized\\acceptance.json'}

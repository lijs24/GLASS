...
- `.\\.venv\\Scripts\\gpwbpp.exe run --plan runs/real_m5_lum_subset/processing_plan.json --out runs/real_m5_lum_subset/gpwbpp_cuda_streaming_masters --backend cuda --until-stage integration --local-normalization off --integration-weighting none --integration-rejection none --tile-size 1024`
- `.\\.venv\\Scripts\\gpwbpp.exe compare --gpwbpp runs/real_m5_lum_subset/gpwbpp_cuda_streaming_masters/integration/master_Lum.fits --reference runs/real_m5_lum_subset/gpwbpp_cuda_tile_reader_manual/integration/master_Lum.fits --out runs/real_m5_lum_subset/gpwbpp_cuda_streaming_masters/compare_vs_tile_reader.html`
...
- Compare against previous tile-reader GPWBPP output:
  - `shape_match`: true
...
- `runs/real_m5_lum_subset/gpwbpp_cuda_streaming_masters/calibration_artifacts.json`
- `runs/real_m5_lum_subset/gpwbpp_cuda_streaming_masters/integration/master_Lum.fits`
- `runs/real_m5_lum_subset/gpwbpp_cuda_streaming_masters/compare_vs_tile_reader.html`
- `runs/real_m5_lum_subset/gpwbpp_cuda_streaming_masters/compare_vs_tile_reader.json`

...
- PASS: `acceptance_audit_passed` - {'status': 'passed', 'path': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_378_fixtures\\missing_phase2_final_checks\\acceptance.json'}
...
- Release quality Phase2 final: present=`False` matrix=`None` manifest=`None`

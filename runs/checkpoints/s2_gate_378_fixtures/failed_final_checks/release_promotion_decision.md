...
- PASS: `acceptance_audit_passed` - {'status': 'passed', 'path': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_378_fixtures\\failed_final_checks\\acceptance.json'}
...
- Release quality final checks ready: `False`
- Release quality final checks match: `True`
- Release quality raw final: present=`True` matrix=`False` manifest=`False`
- Release quality Phase2 final: present=`True` matrix=`False` manifest=`False`

...
- PASS: `acceptance_audit_passed` - {'status': 'passed', 'path': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_378_fixtures\\legacy_without_final_checks\\acceptance.json'}
...
- Release quality raw final: present=`False` matrix=`None` manifest=`None`

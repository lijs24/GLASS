...
- PASS: `doctor_schema_version` - {'actual': 1, 'required': 1, 'path': 'runs\\checkpoints\\s2_gate_181_doctor.json'}
...
- PASS: `acceptance_audit_passed` - {'status': 'passed', 'path': 'C:\\glass_runs\\phase2_s2_gate_181_default_runtime\\acceptance_default_no_preset.json'}

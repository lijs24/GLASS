...
- Status: passed
- Baseline: runs\checkpoints\s2_gate_229_phase2_status.json
- Candidate: runs\checkpoints\s2_gate_230_phase2_status.json

## Summary

- Baseline: {'status': 'green', 'latest_gate': 229, 'acceptance_status': 'passed', 'default_route_acceptance_status': 'passed', 'default_route_acceptance_passed': True, 'cuda_available': True, 'release_manifest_status': 'release_manifest_ready', 'github_release_plan_status': 'release_plan_ready', 'publish_preflight_status': None, 'pipeline_contract_status': 'passed', 'pipeline_contract_passed': True, 'release_decision_status': 'default_change_ready', 'default_change_ready': True}
- Candidate: {'status': 'green', 'latest_gate': 230, 'acceptance_status': 'passed', 'default_route_acceptance_status': 'passed', 'default_route_acceptance_passed': True, 'cuda_available': True, 'release_manifest_status': 'release_manifest_ready', 'github_release_plan_status': 'release_plan_ready', 'publish_preflight_status': 'publish_preflight_ready', 'pipeline_contract_status': 'passed', 'pipeline_contract_passed': True, 'release_decision_status': 'default_change_ready', 'default_change_ready': True}
...
- PASS: latest_checkpoint_gate_not_decreased - {'baseline': 229, 'candidate': 230}
...
- PASS: windows_publish_preflight_ready_preserved - {'baseline': None, 'candidate': 'publish_preflight_ready'}

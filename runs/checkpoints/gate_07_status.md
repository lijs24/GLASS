...
- Added quality-stage support to `glass run --until-stage quality`.
...
- `.\\.venv\\Scripts\\glass synthetic --out runs/gate_07_synth/source --frames 4 --width 40 --height 40 --filter H --known-shift`
- `.\\.venv\\Scripts\\glass audit --root runs/gate_07_synth/source --out runs/gate_07_synth/audit --backend auto`
- `.\\.venv\\Scripts\\glass run --plan runs/gate_07_synth/audit/processing_plan.json --out runs/gate_07_synth/run --backend cuda --until-stage quality --tile-size 10`
- `.\\.venv\\Scripts\\glass report --run runs/gate_07_synth/run --manifest runs/gate_07_synth/audit/manifest.json --plan runs/gate_07_synth/audit/processing_plan.json --out runs/gate_07_synth/report.html`

...
- Default promotion quality publication guard: ready=`False` check=`False` raw=`passed` phase2=`blocked`
...
- PASS: `doctor_schema_version` - {'actual': 1, 'required': 1, 'path': 'runs\\checkpoints\\s2_gate_368_fixtures\\phase2_quality_mismatch\\doctor.json'}
...
- FAIL: `default_promotion_release_decision_quality_compare_publication_guard_passed` - {'present': True, 'ready': False, 'decision_check_passed': False, 'quality_present': True, 'compatible_missing': False, 'layers_ready': False, 'raw_status': 'passed', 'raw_failed_count': 0, 'phase2_status': 'blocked', 'phase2_failed_count': 1}

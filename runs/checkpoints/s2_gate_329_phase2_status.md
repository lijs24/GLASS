...
- Status: green
- Latest checkpoint: S2-Gate 329 (green)
- Checkpoint path: runs\checkpoints\s2_gate_329_phase2_checkpoint_fixture\s2_gate_329_status.md
...
- PASS: latest_checkpoint_green - {'gate': 329, 'status': 'green'}
...
- PASS: release_decision_resident_fastpath_handoff_ready - {'present': True, 'status': 'passed', 'ready': True, 'required': True, 'source': 'explicit_resident_artifacts_json', 'mode': 'similarity_cuda_triangle', 'descriptor_fit_batch_mode': 'native_batch_shared_reference_device', 'pixel_refine_batch_mode': 'native_batch_one_seed_per_frame', 'triangle_warp_batch_mode': 'native_matrix_lanczos3_frames', 'triangle_warp_batch_frame_count': 3, 'warp_copy_mode': 'default_stream_async_device_to_device', 'passed_check_count': 23, 'failed_check_count': 0, 'failed_checks': [], 'failed_acceptance_checks': [], 'path': 'runs\\checkpoints\\s2_gate_327_fastpath_fixture\\resident_artifacts.json'}

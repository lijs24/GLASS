...
- Default promotion release quality final evidence: ready=`False` match=`False` raw=`False` phase2=`True`
...
- PASS: `doctor_schema_version` - {'actual': 1, 'required': 1, 'path': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_386_fixtures\\failed_default_promotion_final_evidence\\doctor.json'}

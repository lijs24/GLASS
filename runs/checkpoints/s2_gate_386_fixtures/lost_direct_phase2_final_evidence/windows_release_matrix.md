...
- Release quality publication final evidence: ready=`False` match=`False` raw=`True` phase2=`None`
...
- PASS: `doctor_schema_version` - {'actual': 1, 'required': 1, 'path': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_386_fixtures\\lost_direct_phase2_final_evidence\\doctor.json'}

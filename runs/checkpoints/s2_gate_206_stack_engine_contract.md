...
- Status: passed
- Run: `runs\checkpoints\s2_gate_206_synthetic_run`
- Scope: `all`
...
- PASS: `calibration_artifact_exists` - {'path': 'runs\\checkpoints\\s2_gate_206_synthetic_run\\calibration_artifacts.json', 'exists': True, 'resident_calibration_contract_attached': False}
...
- PASS: `integration_artifact_exists` - {'path': 'runs\\checkpoints\\s2_gate_206_synthetic_run\\integration_results.json'}

...
- PASS: `latest_checkpoint_green` - {'gate': 302, 'status': 'Green', 'green': True}
...
- PASS: `phase2_embeds_same_release_decision` - {'input': 'runs\\checkpoints\\s2_gate_303_release_decision_resident_winsorized_visibility.json', 'phase2_release_decision_path': 'runs\\checkpoints\\s2_gate_303_release_decision_resident_winsorized_visibility.json'}
...
- PASS: `acceptance_stack_engine_runtime_default_handoff_passed` - {'status': 'passed', 'check_present': True, 'check_passed': True, 'phase2_check_passed': True, 'master_count': 1, 'legacy_master_count': 0, 'failed_master_count': 0, 'failed_output_count': 0, 'explicit_cuda_fast_path_count': 0, 'failed_masters': [], 'failed_outputs': []}
- PASS: `pipeline_stack_engine_runtime_default_handoff_passed` - {'status': 'passed', 'check_present': True, 'check_passed': True, 'phase2_check_passed': True, 'master_count': 0, 'legacy_master_count': 0, 'failed_master_count': 0, 'failed_output_count': 0, 'explicit_cuda_fast_path_count': 0, 'failed_masters': [], 'failed_outputs': []}

...
- Acceptance StackEngine runtime default: `failed` check=`False` legacy=`1` failed-masters=`1` failed-outputs=`0`
...
- PASS: `phase2_embeds_same_release_decision` - {'input': 'runs\\checkpoints\\s2_gate_295_fixtures\\acceptance_runtime_default_failed\\release_decision.json', 'phase2_release_decision_path': 'runs\\checkpoints\\s2_gate_295_fixtures\\acceptance_runtime_default_failed\\release_decision.json'}

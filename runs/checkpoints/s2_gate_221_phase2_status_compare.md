...
- Status: passed
- Baseline: runs\checkpoints\s2_gate_220_phase2_status.json
- Candidate: runs\checkpoints\s2_gate_221_phase2_status.json

## Summary

- Baseline: {'status': 'green', 'latest_gate': 220, 'acceptance_status': 'passed', 'cuda_available': True, 'release_manifest_status': 'release_manifest_ready', 'github_release_plan_status': 'release_plan_ready', 'pipeline_contract_status': 'passed', 'pipeline_contract_passed': True, 'release_decision_status': 'default_change_ready', 'default_change_ready': True}
- Candidate: {'status': 'green', 'latest_gate': 221, 'acceptance_status': 'passed', 'cuda_available': True, 'release_manifest_status': 'release_manifest_ready', 'github_release_plan_status': 'release_plan_ready', 'pipeline_contract_status': 'passed', 'pipeline_contract_passed': True, 'release_decision_status': 'default_change_ready', 'default_change_ready': True}
...
- PASS: latest_checkpoint_gate_not_decreased - {'baseline': 220, 'candidate': 221}

...
- Status: passed
- Baseline: runs\checkpoints\s2_gate_216_phase2_status.json
- Candidate: runs\checkpoints\s2_gate_217_phase2_status.json

## Summary

- Baseline: {'status': 'green', 'latest_gate': 216, 'acceptance_status': 'passed', 'cuda_available': True, 'release_manifest_status': 'release_manifest_ready', 'github_release_plan_status': 'release_plan_ready', 'pipeline_contract_status': 'passed', 'pipeline_contract_passed': True}
- Candidate: {'status': 'green', 'latest_gate': 217, 'acceptance_status': 'passed', 'cuda_available': True, 'release_manifest_status': 'release_manifest_ready', 'github_release_plan_status': 'release_plan_ready', 'pipeline_contract_status': 'passed', 'pipeline_contract_passed': True}
...
- PASS: latest_checkpoint_gate_not_decreased - {'baseline': 216, 'candidate': 217}

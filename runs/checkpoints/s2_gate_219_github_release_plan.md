...
- Tag: `v0.1.0-phase2-gate219`
- Title: `GLASS Phase 2 Gate 219 Windows packages`
- Source stamps: `aa63510`
- GitHub CLI available: `False`
- GitHub CLI auth OK: `False`
- Publish script: `C:\Users\ljs\WORK\astro\gpuwbpp\runs\checkpoints\s2_gate_219_publish_release.ps1`
...
- Phase 2 status path: `runs\checkpoints\s2_gate_219_phase2_status.json`
- Phase 2 status: `green`
- Phase 2 latest gate: `219`
...
- Phase 2 status compare path: `runs\checkpoints\s2_gate_219_phase2_status_compare.json`
- Phase 2 status compare: `passed`
- Phase 2 compare baseline gate: `218`
- Phase 2 compare candidate gate: `219`

## Command

```powershell
gh release create v0.1.0-phase2-gate219 'C:\Users\ljs\WORK\astro\gpuwbpp\.release\windows\GLASS-Portable-win64-cuda13.zip' 'C:\Users\ljs\WORK\astro\gpuwbpp\.release\windows\GLASS-Portable-win64-cuda12.zip' 'C:\Users\ljs\WORK\astro\gpuwbpp\.release\windows\GLASS-Portable-win64-cuda11.zip' 'C:\Users\ljs\WORK\astro\gpuwbpp\.release\windows\GLASS-Portable-win64-cpu.zip' --title 'GLASS Phase 2 Gate 219 Windows packages' --notes-file 'C:\Users\ljs\WORK\astro\gpuwbpp\runs\checkpoints\s2_gate_219_release_notes.md' --draft
```
...
- PASS: `phase2_status_present` - {'path': 'runs\\checkpoints\\s2_gate_219_phase2_status.json'}
- PASS: `phase2_status_type` - {'artifact_type': 'glass_phase2_status', 'required': 'glass_phase2_status'}
- PASS: `phase2_status_green` - {'status': 'green', 'passed': True, 'latest_gate': 219}
- PASS: `phase2_status_compare_present` - {'path': 'runs\\checkpoints\\s2_gate_219_phase2_status_compare.json'}
- PASS: `phase2_status_compare_type` - {'artifact_type': 'glass_phase2_status_compare', 'required': 'glass_phase2_status_compare'}
- PASS: `phase2_status_compare_passed` - {'status': 'passed', 'passed': True, 'baseline_gate': 218, 'candidate_gate': 219}

...
- Pipeline contract path: C:\glass_runs\phase2_s2_gate_211_native_result_contract\guardrails\pipeline_contract.json
- Pipeline contract audit type: pipeline_invariant_contract
- Pipeline contract passed: True
- Pipeline contract checks: 15
- Acceptance pipeline checks passed: 10
- Acceptance pipeline checks failed: 0
- Failed pipeline checks: []

- PASS: pipeline_contract_present - {'path': 'C:\\glass_runs\\phase2_s2_gate_211_native_result_contract\\guardrails\\pipeline_contract.json', 'exists': True, 'audit_type': 'pipeline_invariant_contract'}
- PASS: pipeline_contract_passed - {'status': 'passed', 'failed_checks': []}
- PASS: contract_pipeline_contract_present - {'required': True, 'present': True, 'path': 'C:\\glass_runs\\phase2_s2_gate_211_native_result_contract\\guardrails\\pipeline_contract.json'}
...
- PASS: contract_pipeline_contract_min_check_count - {'actual': 15, 'required_min': 3}
- PASS: contract_pipeline_contract_check:calibration_master_surface_contract - {'required': 'calibration_master_surface_contract', 'available': ['integration_artifact_exists', 'integration_outputs_present', 'integration_output_maps_available', 'integration_dq_contract', 'integration_stack_result_contract', 'integration_resident_result_contract', 'calibration_master_surfaces_present', 'calibration_master_surface_contract', 'resident_calibration_surface_contract', 'resident_calibrated_lights_present', 'resident_calibrated_light_contract', 'integration_dq_map_pixels_match_summary', 'integration_coverage_map_pixels_match_dq', 'integration_rejection_map_pixels_match_dq', 'local_normalization_contract']}
- PASS: contract_pipeline_contract_check:resident_calibrated_light_contract - {'required': 'resident_calibrated_light_contract', 'available': ['integration_artifact_exists', 'integration_outputs_present', 'integration_output_maps_available', 'integration_dq_contract', 'integration_stack_result_contract', 'integration_resident_result_contract', 'calibration_master_surfaces_present', 'calibration_master_surface_contract', 'resident_calibration_surface_contract', 'resident_calibrated_lights_present', 'resident_calibrated_light_contract', 'integration_dq_map_pixels_match_summary', 'integration_coverage_map_pixels_match_dq', 'integration_rejection_map_pixels_match_dq', 'local_normalization_contract']}
...
- Status: passed
- Required by benchmark contract: True
- StackEngine contract path: C:\glass_runs\phase2_s2_gate_211_native_result_contract\guardrails\stack_engine_contract.json
...
- PASS: stack_engine_contract_present - {'path': 'C:\\glass_runs\\phase2_s2_gate_211_native_result_contract\\guardrails\\stack_engine_contract.json', 'exists': True, 'audit_type': 'stack_engine_default_contract'}
- PASS: stack_engine_contract_passed - {'status': 'passed', 'failed_checks': []}
- PASS: contract_stack_engine_default_promotion_present - {'required': True, 'present': True, 'path': 'C:\\glass_runs\\phase2_s2_gate_211_native_result_contract\\guardrails\\stack_engine_contract.json'}
...
- Artifact keys: ['guardrails_summary', 'pipeline_contract', 'pipeline_contract_markdown', 'report', 'resident_calibration_contract', 'resident_result_contract', 'stack_engine_contract', 'stack_engine_contract_markdown']
- Missing artifacts: []
...
- Guardrails summary: C:\glass_runs\phase2_s2_gate_211_native_result_contract\guardrails\guardrails_summary.json
- Resident result contract source: run_default
- Resident result contract run default: True
- Resident result contract: C:\glass_runs\phase2_s2_gate_209_native_artifact\contract_view\resident_result_contract.json
- Resident native calibration artifact: True
- Resident calibration master count: 3
- Resident calibrated light count: 200

## Resident Bundle Contracts

- result: status=passed passed=True type=resident_cuda_result_contract checks=3 path=C:\glass_runs\phase2_s2_gate_209_native_artifact\contract_view\resident_result_contract.json
...
- PASS: contract_bundle_present - {'path': 'C:\\glass_runs\\phase2_s2_gate_211_native_result_contract\\guardrails\\acceptance_contract_bundle.json', 'exists': True}
- PASS: contract_bundle_type - {'path': 'C:\\glass_runs\\phase2_s2_gate_211_native_result_contract\\guardrails\\acceptance_contract_bundle.json', 'artifact_type': 'glass_acceptance_contract_bundle', 'required': 'glass_acceptance_contract_bundle'}
...
- PASS: contract_bundle_required_artifacts - {'required': ['guardrails_summary', 'pipeline_contract', 'stack_engine_contract'], 'missing': [], 'actual': ['guardrails_summary', 'pipeline_contract', 'pipeline_contract_markdown', 'report', 'resident_calibration_contract', 'resident_result_contract', 'stack_engine_contract', 'stack_engine_contract_markdown']}
...
- PASS: resident_result_contract_present - {'path': 'C:\\glass_runs\\phase2_s2_gate_209_native_artifact\\contract_view\\resident_result_contract.json', 'exists': True}
- PASS: resident_result_contract_type - {'path': 'C:\\glass_runs\\phase2_s2_gate_209_native_artifact\\contract_view\\resident_result_contract.json', 'artifact_type': 'resident_cuda_result_contract', 'required': 'resident_cuda_result_contract'}
- PASS: resident_result_contract_passed - {'status': 'passed', 'failed_checks': []}
- PASS: pipeline_contract_present - {'path': 'C:\\glass_runs\\phase2_s2_gate_211_native_result_contract\\guardrails\\pipeline_contract.json', 'exists': True, 'audit_type': 'pipeline_invariant_contract'}
- PASS: pipeline_contract_passed - {'status': 'passed', 'failed_checks': []}
- PASS: stack_engine_contract_present - {'path': 'C:\\glass_runs\\phase2_s2_gate_211_native_result_contract\\guardrails\\stack_engine_contract.json', 'exists': True, 'audit_type': 'stack_engine_default_contract'}
- PASS: stack_engine_contract_passed - {'status': 'passed', 'failed_checks': []}
...
- PASS: contract_resident_registration_fastpath_present - {'path': 'C:\\glass_runs\\phase2_s2_gate_209_native_artifact\\contract_view\\resident_artifacts.json', 'exists': True, 'available': True, 'artifact_count': 1}

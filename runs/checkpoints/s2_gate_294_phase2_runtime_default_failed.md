...
- Pipeline StackEngine runtime default: failed check=False masters=1 legacy=1 failed_masters=1 failed_outputs=0 explicit_cuda=0
...
- FAIL: acceptance_audit_passed - {'status': 'failed', 'speedup_vs_reference': 58.0}
...
- FAIL: acceptance_pipeline_stack_engine_runtime_default_passed - {'status': 'failed', 'check_present': True, 'check_passed': False, 'master_count': 1, 'legacy_master_count': 1, 'failed_master_count': 1, 'failed_output_count': 0, 'explicit_cuda_fast_path_count': 0}

...
- Residual max RMS: 0.0
- Residual max abs: 0.0

## Checks

- PASS: local_norm_results_present - {'path': 'runs\\checkpoints\\s2_gate_316_enabled_run\\local_norm_results.json'}
...
- PASS: reference_frame_id_recorded - {'reference_frame_id': 'F000010'}
...
- PASS: F000010 status=reference model=continuous_grid_mean_std_v1 failed=[]

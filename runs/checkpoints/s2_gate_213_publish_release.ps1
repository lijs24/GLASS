...
$ExpectedTag = 'v0.1.0-phase2-gate213'
$ReleaseTitle = 'GLASS Phase 2 Gate 213 Windows packages'
$NotesFile = 'C:\Users\ljs\WORK\astro\gpuwbpp\runs\checkpoints\s2_gate_213_release_notes.md'
$Phase2StatusFile = 'runs\checkpoints\s2_gate_213_phase2_status.json'
$Phase2StatusCompareFile = 'runs\checkpoints\s2_gate_213_phase2_status_compare.json'
$Assets = @(

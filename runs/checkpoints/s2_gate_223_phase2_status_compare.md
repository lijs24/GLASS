...
- Status: passed
- Baseline: runs\checkpoints\s2_gate_222_phase2_status.json
- Candidate: runs\checkpoints\s2_gate_223_phase2_status.json

## Summary

- Baseline: {'status': 'green', 'latest_gate': 222, 'acceptance_status': 'passed', 'cuda_available': True, 'release_manifest_status': 'release_manifest_ready', 'github_release_plan_status': 'release_plan_ready', 'pipeline_contract_status': 'passed', 'pipeline_contract_passed': True, 'release_decision_status': 'default_change_ready', 'default_change_ready': True}
- Candidate: {'status': 'green', 'latest_gate': 223, 'acceptance_status': 'passed', 'cuda_available': True, 'release_manifest_status': 'release_manifest_ready', 'github_release_plan_status': 'release_plan_ready', 'pipeline_contract_status': 'passed', 'pipeline_contract_passed': True, 'release_decision_status': 'default_change_ready', 'default_change_ready': True}
...
- PASS: latest_checkpoint_gate_not_decreased - {'baseline': 222, 'candidate': 223}
...
- PASS: resident_registration_fastpath_contract_passed_preserved - {'baseline': 'not_requested', 'candidate': 'passed'}
- PASS: resident_registration_fastpath_contract_check_count_preserved - {'baseline': 0, 'candidate': 24}

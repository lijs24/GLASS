...
- Release quality compare sources: raw=`passed` phase2=`blocked` raw-failed=`0` phase2-failed=`1`
...
- PASS: `phase2_embeds_same_release_decision` - {'input': 'runs\\checkpoints\\s2_gate_367_fixtures\\phase2_quality_mismatch\\decision.json', 'phase2_release_decision_path': 'runs\\checkpoints\\s2_gate_367_fixtures\\phase2_quality_mismatch\\decision.json'}
...
- FAIL: `release_decision_quality_compare_publication_guard_passed` - {'present': True, 'ready': False, 'decision_check_passed': False, 'status': 'passed', 'passed': False, 'checks_passed': False, 'compatible_missing': False, 'quality_compare_present': True, 'decision_check_ready': False, 'checks_ready': False, 'layers_ready': False, 'raw_present': True, 'raw_ready': True, 'raw_matrix_status': 'passed', 'raw_matrix_failed_check_count': 0, 'raw_default_promotion_status': 'passed', 'raw_default_promotion_failed_check_count': 0, 'phase2_present': True, 'phase2_ready': False, 'phase2_check_passed': False, 'phase2_matrix_status': 'blocked', 'phase2_matrix_failed_check_count': 1, 'phase2_default_promotion_status': 'blocked', 'phase2_default_promotion_failed_check_count': 1, 'failed_checks': ['stack_engine_publication_quality_metrics_compare_passed']}

...
$ExpectedTag = 's2-gate-341-failed'
$ReleaseTitle = 'GLASS S2 Gate 341 Failed Fixture'
$NotesFile = 'C:\Users\ljs\WORK\astro\gpuwbpp\runs\checkpoints\s2_gate_341_release_notes_failed_resident_result.md'
$WindowsReleaseMatrixFile = 'runs\checkpoints\s2_gate_340_windows_release_matrix_failed_resident_result.json'
$Phase2StatusFile = $null
$Phase2StatusCompareFile = $null
$Assets = @(
    @{ Label = 'cuda13'; Path = 'C:\Users\ljs\WORK\astro\gpuwbpp\runs\checkpoints\s2_gate_341_fixture\GLASS-Portable-win64-cuda13.zip'; Sha256 = '81ef7633b1c7d700aff468c131055ee625b5f2efcc31b67ebaa1a1b35efb3d98'; SizeBytes = 20 },
    @{ Label = 'cuda12'; Path = 'C:\Users\ljs\WORK\astro\gpuwbpp\runs\checkpoints\s2_gate_341_fixture\GLASS-Portable-win64-cuda12.zip'; Sha256 = 'a661671be01d3028d5580c506adf858600c1252c621cdc8d6dfc4a462e3b7fd6'; SizeBytes = 20 },
    @{ Label = 'cuda11'; Path = 'C:\Users\ljs\WORK\astro\gpuwbpp\runs\checkpoints\s2_gate_341_fixture\GLASS-Portable-win64-cuda11.zip'; Sha256 = 'ca9d8a29bf75e27ef6e0d7eab2d6ee23496e78314be793293f219f2aa9918256'; SizeBytes = 20 },
    @{ Label = 'cpu'; Path = 'C:\Users\ljs\WORK\astro\gpuwbpp\runs\checkpoints\s2_gate_341_fixture\GLASS-Portable-win64-cpu.zip'; Sha256 = '843662196aad1d87a22bfff89308b04f5b579a43a9c945d823ae7a91a634a48e'; SizeBytes = 17 }
)

...
- Added pybind wrapper and Python `gpwbpp_cuda.mean_stack_tiles_f32`.
- Implemented `gpwbpp.gpu.master_frames.mean_stack_paths_tile_streaming`.
...
- Later benchmark gate: compare GPWBPP runtime against PixInsight/WBPP black-box output on the same small real dataset.

...
.\.venv\Scripts\python.exe benchmarks\compare_astroalign_gpu_alignment.py --reference C:\glass_runs\final_m38_h_200\glass_cuda_run\calib_cache\calibrated\calibrated_F000061.fits --moving C:\glass_runs\final_m38_h_200\glass_cuda_run\calib_cache\calibrated\calibrated_F000080.fits --center-crop 1024 --max-shift 128 --out runs\alignment_compare\astroalign_vs_gpu_alignment_m38_crop_061_080.json
```
...
- Synthetic astroalign comparison:
  ...
  - GLASS CUDA: dx=-7, dy=5, elapsed 0.0602 s, RMS 0.0.
...
- Real M38 calibrated crop comparison:
  ...
  - GLASS CUDA: dx=9, dy=1, elapsed 0.1268 s, RMS 81.49.
...
- Astroalign is used only as an open-source comparison reference and is not
  part of GLASS runtime alignment.
...
synthetic data, GLASS-generated calibrated FITS outputs, and the open-source

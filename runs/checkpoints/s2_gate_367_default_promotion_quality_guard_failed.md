...
- Release quality compare publication guard: ready=`False` check=`False` quality-present=`True` compatible-missing=`False`
- Release quality compare sources: raw=`blocked` phase2=`blocked` raw-failed=`1` phase2-failed=`1`
...
- PASS: `phase2_embeds_same_release_decision` - {'input': 'runs\\checkpoints\\s2_gate_367_fixtures\\failed_quality_guard\\decision.json', 'phase2_release_decision_path': 'runs\\checkpoints\\s2_gate_367_fixtures\\failed_quality_guard\\decision.json'}
...
- FAIL: `release_decision_quality_compare_publication_guard_passed` - {'present': True, 'ready': False, 'decision_check_passed': False, 'status': 'blocked', 'passed': False, 'checks_passed': False, 'compatible_missing': False, 'quality_compare_present': True, 'decision_check_ready': False, 'checks_ready': False, 'layers_ready': False, 'raw_present': True, 'raw_ready': False, 'raw_matrix_status': 'blocked', 'raw_matrix_failed_check_count': 1, 'raw_default_promotion_status': 'blocked', 'raw_default_promotion_failed_check_count': 1, 'phase2_present': True, 'phase2_ready': False, 'phase2_check_passed': False, 'phase2_matrix_status': 'blocked', 'phase2_matrix_failed_check_count': 1, 'phase2_default_promotion_status': 'blocked', 'phase2_default_promotion_failed_check_count': 1, 'failed_checks': ['stack_engine_publication_quality_metrics_compare_passed']}

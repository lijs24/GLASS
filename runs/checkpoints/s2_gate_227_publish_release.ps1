...
$ExpectedTag = 'v0.1.0-phase2-gate227'
$ReleaseTitle = 'GLASS Phase 2 Gate 227 Windows packages'
$NotesFile = 'C:\Users\ljs\WORK\astro\gpuwbpp\runs\checkpoints\s2_gate_227_github_release_notes.md'
$WindowsReleaseMatrixFile = 'runs\checkpoints\s2_gate_226_windows_release_matrix.json'
$Phase2StatusFile = 'runs\checkpoints\s2_gate_226_phase2_status.json'
$Phase2StatusCompareFile = 'runs\checkpoints\s2_gate_226_phase2_status_compare.json'
$Assets = @(

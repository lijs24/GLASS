...
- StackEngine runtime default: ready=`None` acceptance=`None` pipeline=`None`
...
- PASS: `doctor_schema_version` - {'actual': 1, 'required': 1, 'path': 'runs\\checkpoints\\s2_gate_296_fixtures\\runtime_default_missing\\doctor.json'}

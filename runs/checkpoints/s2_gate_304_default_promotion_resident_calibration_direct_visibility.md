...
- PASS: `latest_checkpoint_green` - {'gate': 303, 'status': 'Green', 'green': True}
...
- PASS: `phase2_embeds_same_release_decision` - {'input': 'runs\\checkpoints\\s2_gate_304_release_decision_resident_calibration_direct_visibility.json', 'phase2_release_decision_path': 'runs\\checkpoints\\s2_gate_304_release_decision_resident_calibration_direct_visibility.json'}

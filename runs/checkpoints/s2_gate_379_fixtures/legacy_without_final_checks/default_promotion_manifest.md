...
- Release quality publication final checks: ready=`True` match=`True` compatible-missing=`True` raw-present=`False` phase2-present=`False`
- Release quality publication final values: raw-matrix=`None` raw-manifest=`None` phase2-matrix=`None` phase2-manifest=`None`
...
- PASS: `phase2_embeds_same_release_decision` - {'input': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_379_fixtures\\legacy_without_final_checks\\release_decision.json', 'phase2_release_decision_path': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_379_fixtures\\legacy_without_final_checks\\release_decision.json'}

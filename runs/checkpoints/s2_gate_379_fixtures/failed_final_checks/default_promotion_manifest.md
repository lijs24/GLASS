...
- Release quality publication final checks: ready=`False` match=`True` compatible-missing=`False` raw-present=`True` phase2-present=`True`
- Release quality publication final values: raw-matrix=`False` raw-manifest=`False` phase2-matrix=`False` phase2-manifest=`False`
...
- PASS: `phase2_embeds_same_release_decision` - {'input': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_379_fixtures\\failed_final_checks\\release_decision.json', 'phase2_release_decision_path': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_379_fixtures\\failed_final_checks\\release_decision.json'}

...
- PASS: contract_bundle_present - {'path': 'runs\\checkpoints\\s2_gate_200_acceptance_contract_bundle.json', 'exists': True}
- PASS: contract_bundle_type - {'path': 'runs\\checkpoints\\s2_gate_200_acceptance_contract_bundle.json', 'artifact_type': 'glass_acceptance_contract_bundle', 'required': 'glass_acceptance_contract_bundle'}

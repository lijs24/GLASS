...
$ExpectedTag = 'v0.1.0-gate307-preflight'
$ReleaseTitle = 'GLASS Windows Gate307 Preflight'
$NotesFile = 'C:\Users\ljs\WORK\astro\gpuwbpp\runs\checkpoints\s2_gate_307_github_release_notes_direct_runtime_evidence.md'
$WindowsReleaseMatrixFile = 'runs\checkpoints\s2_gate_306_windows_release_matrix_direct_runtime_evidence.json'
$Phase2StatusFile = 'runs\checkpoints\s2_gate_305_phase2_status_direct_acceptance_fastpath.json'

...
- Coverage sample delta: `10633`
- Pre-rejection sample delta: `10713`
- Same-pre-rejection abs rejected delta: `795`
- Rejection mismatch pixels: `1109`
...
- Rejected sample delta: `96`
- Abs rejected sample delta: `406`
- Coverage sample delta: `10617`
- Pre-rejection sample delta: `10713`
- Rejection mismatch pixels: `362`

## Top Tiles

| y0 | y1 | x0 | x1 | rejected delta | abs rejected | coverage delta | pre-rejection delta | mismatch px |
| ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 448 | 512 | 0 | 64 | 29 | 53 | 1091 | 1120 | 49 |
| 448 | 512 | 128 | 192 | 2 | 50 | 702 | 704 | 44 |
| 448 | 512 | 448 | 512 | 20 | 46 | 745 | 765 | 43 |
| 384 | 448 | 0 | 64 | 9 | 43 | 439 | 448 | 41 |
...
- PASS: `resident_maps_present` - {'maps': {'coverage': {'path_key': 'coverage_map_path', 'path': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_423_common_footprint_refF16_cuda_hardened\\integration\\resident_coverage_map_H.fits', 'exists': True}, 'low_rejection': {'path_key': 'low_rejection_map_path', 'path': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_423_common_footprint_refF16_cuda_hardened\\integration\\resident_low_rejection_map_H.fits', 'exists': True}, 'high_rejection': {'path_key': 'high_rejection_map_path', 'path': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_423_common_footprint_refF16_cuda_hardened\\integration\\resident_high_rejection_map_H.fits', 'exists': True}, 'dq': {'path_key': 'dq_map_path', 'path': 'C:\\Users\\ljs\\WORK\\astro\\gpuwbpp\\runs\\checkpoints\\s2_gate_423_common_footprint_refF16_cuda_hardened\\integration\\resident_dq_map_H.fits', 'exists': True}}}
...
- PASS: `rejected_sample_delta_within_limit` - {'delta': -16, 'max_abs_delta': 64, 'evaluation_region': 'compare_region'}
...
- PASS: `same_pre_rejection_semantic_delta_within_limit` - {'abs_delta': 760, 'max_abs_delta': 1024, 'evaluation_region': 'compare_region'}

...
$ReleaseTitle = 'GLASS v0.1.0-windows-gpu.9 Windows packages'
$NotesFile = 'C:\Users\ljs\WORK\astro\gpuwbpp\runs\checkpoints\s2_gate_205_release_notes_phase2_preflight.md'
$Phase2StatusFile = 'runs\checkpoints\s2_gate_205_phase2_status.json'
$Phase2StatusCompareFile = 'runs\checkpoints\s2_gate_205_phase2_status_compare.json'
$Assets = @(

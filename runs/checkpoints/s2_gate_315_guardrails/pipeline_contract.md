...
- Status: passed
- Run: `runs\checkpoints\s2_gate_314_cpu_run`

## Checks

- PASS: `integration_artifact_exists` - {'path': 'runs\\checkpoints\\s2_gate_314_cpu_run\\integration_results.json'}
...
- PASS: `local_normalization_continuous_contract_audit` - {'status': 'passed', 'artifact_type': 'local_norm_contract', 'enabled': False, 'output_count': 1, 'pipeline_row_count': 1, 'failed_output_count': 0, 'failed_checks': [], 'failed_outputs': [], 'failed_contract_rows': []}

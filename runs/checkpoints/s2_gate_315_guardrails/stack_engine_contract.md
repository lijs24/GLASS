...
- PASS: `calibration_artifact_exists` - {'path': 'runs\\checkpoints\\s2_gate_314_cpu_run\\calibration_artifacts.json', 'exists': True, 'resident_calibration_contract_attached': False}

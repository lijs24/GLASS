...
.\.venv\Scripts\python.exe -m glass.cli run --plan C:\glass_runs\final_m38_h_200\processing_plan.json --out C:\glass_runs\final_m38_h_200\glass_resident_winsorized_run --backend cuda --memory-mode resident --until-stage integration --local-normalization off --integration-rejection winsorized_sigma --integration-weighting none
.\.venv\Scripts\python.exe -m glass.cli run --plan C:\glass_runs\final_m38_h_200\processing_plan_flatfloor005.json --out C:\glass_runs\final_m38_h_200\glass_resident_winsorized_flatfloor005_run --backend cuda --memory-mode resident --until-stage integration --local-normalization off --integration-rejection winsorized_sigma --integration-weighting none
.\.venv\Scripts\python.exe -m glass.cli run --plan C:\glass_runs\final_m38_h_200\processing_plan.json --out C:\glass_runs\final_m38_h_200\glass_resident_winsorized_flatfloor005_cli_run --backend cuda --memory-mode resident --until-stage integration --local-normalization off --integration-rejection winsorized_sigma --integration-weighting none --flat-floor 0.05
.\.venv\Scripts\python.exe -m glass.cli compare --glass C:\glass_runs\final_m38_h_200\glass_resident_winsorized_flatfloor005_run\integration\resident_master_H.fits --reference C:\glass_runs\final_m38_h_200\pixinsight_wbpp_blackbox\master\masterLight_BIN-1_9600x6422_EXPOSURE-600.00s_FILTER-H_mono_fastIntegration.xisf --out C:\glass_runs\final_m38_h_200\winsorized_flatfloor005_scaled_resident_vs_wbpp_compare.html --glass-time-seconds 64.94495560001815 --reference-time-seconds 1092.541 --glass-label GLASS-resident-winsorized-flatfloor005-scaled --reference-label PixInsight-WBPP-fastIntegration --glass-scale 0.000015259021896696421 --clip-low 0 --clip-high 1
.\.venv\Scripts\python.exe -m glass.cli compare --glass C:\glass_runs\final_m38_h_200\glass_resident_winsorized_flatfloor005_cli_run\integration\resident_master_H.fits --reference C:\glass_runs\final_m38_h_200\pixinsight_wbpp_blackbox\master\masterLight_BIN-1_9600x6422_EXPOSURE-600.00s_FILTER-H_mono_fastIntegration.xisf --out C:\glass_runs\final_m38_h_200\winsorized_flatfloor005_cli_scaled_resident_vs_wbpp_compare.html --glass-time-seconds 64.39926949999062 --reference-time-seconds 1092.541 --glass-label GLASS-resident-winsorized-flatfloor005-cli-scaled --reference-label PixInsight-WBPP-fastIntegration --glass-scale 0.000015259021896696421 --clip-low 0 --clip-high 1
...
- Raising `flat_floor` to 0.05 removed `gt_65535` pixels in the resident
  ...
  ~621 ADU.
- Scaled GLASS-vs-WBPP comparison for the diagnostic run reached median

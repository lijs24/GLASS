    ...
    return [
        {
            ...
            "integration_conflict_frames": summary.get("integration_conflict_frames"),
        ...
        rows.append(
            {
                ...
                "integration_conflict_count": item.get("integration_conflict_count"),
        ...
        rows.append(
            {
                ...
                "catalog_stream_count": registration.get("triangle_catalog_stream_count"),
                "catalog_batch_sync_count": registration.get("triangle_catalog_batch_sync_count"),
                "catalog_sync_phase_count": registration.get("triangle_catalog_sync_phase_count"),

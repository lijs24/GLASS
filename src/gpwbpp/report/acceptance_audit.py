...
from gpwbpp.report.speedup_report import _read_json_lenient, summarize_wbpp_speedup
    ...
    *,
    ...
    return {
        ...
        "clean_room": {
            "status": "compliant",
            "note": (
                "Acceptance audit consumes GPWBPP artifacts and user-generated PixInsight/WBPP "

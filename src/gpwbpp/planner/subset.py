...
from gpwbpp.models import FrameRecord, now_iso, to_jsonable
from gpwbpp.planner.grouping import group_frames
from gpwbpp.planner.matching import find_bias_group, find_dark_group, find_flat_group
...
def _renumber(frames: list[FrameRecord]) -> list[FrameRecord]:
    ...
    for index, frame in enumerate(frames, start=1):
        ...
        cloned.header_summary["GPWBPP_SOURCE_ID"] = original_id
        out.append(cloned)
    return out

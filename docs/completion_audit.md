...
| Master calibration out-of-core path | `src/gpwbpp/engine/pipeline.py`, `runs/checkpoints/streaming_master_frames_status.md`, `runs/checkpoints/exact_flat_median_status.md` | covered for mean master bias/dark/flat and exact median flat normalization |
...
| Quality metrics/reference selection | Gate 7 checkpoint, tests | covered baseline |
